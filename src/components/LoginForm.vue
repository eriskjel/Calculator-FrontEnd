  ...
  <template>
    <div class="body">
      <form @submit.prevent="sendForm" class="form">
        <h1>Login</h1>
        <BaseInput id="inpName" class="input-container" type="text" label="Name" v-model="form.username"/>
        <BaseInput id="inpEmail" class="input-container" type="text" label="Password" v-model="form.password"/>
